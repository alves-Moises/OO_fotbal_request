...
button_player3 = Button(text="Liga", width=10, command=request_league_by_name)
button_player3.grid(row=10,column=3)

button_player4 = Button(text="Temporada", width=10, command=request_season)
button_player4.grid(row=11,column=1)

button_player6 = Button(text="Liga (lista)", width=10, command=request_league)
